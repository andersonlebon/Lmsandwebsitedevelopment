...
import { IdCard, ClipboardCheck, Award } from 'lucide-react';
import { useLanguage } from '../../../context/LanguageContext';

const tabs = [
  { to: 'student-id', labelKey: 'common.studentID', icon: IdCard },
  { to: 'attendance', labelKey: 'common.myAttendance', icon: ClipboardCheck },
  { to: 'certificates', labelKey: 'common.certificates', icon: Award },
];
