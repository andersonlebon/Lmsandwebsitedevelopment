...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'learning.assignToClassEvents': { en: 'Assign to class event', fr: 'Assigner au créneau (cours)' },
  ...
  'staff.activitiesAndGrading': { en: 'Exercises & grading', fr: 'Exercices et notation' },
